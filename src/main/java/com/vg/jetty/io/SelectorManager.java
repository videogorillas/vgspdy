...
import com.vg.jetty.util.ArrayQueue;
import com.vg.jetty.util.ConcurrentArrayQueue;
import com.vg.jetty.util.TypeUtil;
import com.vg.jetty.util.annotation.ManagedAttribute;
...
import com.vg.jetty.util.thread.NonBlockingThread;
...
public abstract class SelectorManager extends AbstractLifeCycle implements Dumpable
{
    ...
    {
        private final AtomicReference<State> _state= new AtomicReference<State>(State.PROCESSING);
        private List<Runnable> _runChanges = new ArrayList<Runnable>();
        private List<Runnable> _addChanges = new ArrayList<Runnable>();
        ...
        private void closeNoExceptions(Selector closeable)
        {
            try
            {
                if (closeable != null)
