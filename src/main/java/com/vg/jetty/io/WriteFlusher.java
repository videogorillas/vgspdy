...
import com.vg.jdk6.WritePendingException;
...
abstract public class WriteFlusher
{
    ...
    private static final EnumMap<StateType, Set<StateType>> __stateTransitions = new EnumMap<StateType, Set<StateType>>(StateType.class);
    ...
    private final AtomicReference<State> _state = new AtomicReference<State>();
