...
import com.vg.jetty.io.MappedByteBufferPool;
import com.vg.jetty.io.NegotiatingClientConnectionFactory;
import com.vg.jetty.io.SelectChannelEndPoint;
import com.vg.jetty.io.SelectorManager;
import com.vg.jetty.io.ssl.SslClientConnectionFactory;
import com.vg.jetty.npn.client.NPNClientConnectionFactory;
...
import com.vg.jetty.util.ssl.SslContextFactory;
import com.vg.jetty.util.thread.QueuedThreadPool;
import com.vg.jetty.util.thread.ScheduledExecutorScheduler;
...
public class SPDYClient
{
    ...
    public void connect(final SocketAddress address, final SessionFrameListener listener, final Promise<Session> promise, Map<String, Object> context)
    {
        ...
        try
        {
            ...
            if (bindAddress != null) {
                throw new IllegalStateException("channel.bind not supported on jdk6 "+bindAddress);
...
//            context.put(SslClientConnectionFactory.SSL_PEER_HOST_CONTEXT_KEY, ((InetSocketAddress)address).getHostString());
            context.put(SslClientConnectionFactory.SSL_PEER_HOST_CONTEXT_KEY, ((InetSocketAddress)address).getHostName());
