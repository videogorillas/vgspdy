...
{
    private static final int _0x7F_FF_FF_FF = 0x7FFFFFFF;
        ...
        while (buffer.hasRemaining())
        {
            switch (state)
            {
                case STREAM_ID:
                {
                    ...
                    {
                        streamId = buffer.getInt() & _0x7F_FF_FF_FF;
                ...
                case WINDOW_DELTA:
                {
                    if (buffer.remaining() >= 4)
                    {
                        windowDelta = buffer.getInt() & _0x7F_FF_FF_FF;
                        onWindowUpdate();
                        return true;
                    }
                    else
