...
public class Flusher
{
    ...
    private final ArrayQueue<StandardSession.FrameBytes> queue = new ArrayQueue<FrameBytes>(ArrayQueue.DEFAULT_CAPACITY, ArrayQueue.DEFAULT_GROWTH, lock);
    ...
    {
        private final List<StandardSession.FrameBytes> active = new ArrayList<FrameBytes>(maxGather);
        private final List<StandardSession.FrameBytes> succeeded = new ArrayList<FrameBytes>(maxGather);
        private final Set<IStream> stalled = new HashSet<IStream>();
        ...
        {
            List<StandardSession.FrameBytes> failed = new ArrayList<FrameBytes>();
            synchronized (lock)
            {
                failure = x;
                if (LOG.isDebugEnabled())
