...
import com.vg.jdk6.InterruptedByTimeoutException;
import com.vg.jdk6.Objects;
import com.vg.jetty.io.ByteBufferPool;
import com.vg.jetty.io.EndPoint;
import com.vg.jetty.spdy.api.ByteBufferDataInfo;
...
import com.vg.jetty.spdy.api.PingInfo;
import com.vg.jetty.spdy.api.PingResultInfo;
import com.vg.jetty.spdy.api.PushInfo;
import com.vg.jetty.spdy.api.RstInfo;
import com.vg.jetty.spdy.api.SPDYException;
...
import com.vg.jetty.spdy.frames.ControlFrameType;
import com.vg.jetty.spdy.frames.CredentialFrame;
import com.vg.jetty.spdy.frames.DataFrame;
import com.vg.jetty.spdy.frames.GoAwayFrame;
import com.vg.jetty.spdy.frames.HeadersFrame;
import com.vg.jetty.spdy.frames.PingFrame;
import com.vg.jetty.spdy.frames.RstStreamFrame;
import com.vg.jetty.spdy.frames.SettingsFrame;
import com.vg.jetty.spdy.frames.SynReplyFrame;
...
import com.vg.jetty.util.Atomics;
import com.vg.jetty.util.BufferUtil;
import com.vg.jetty.util.Callback;
import com.vg.jetty.util.FutureCallback;
import com.vg.jetty.util.FuturePromise;
import com.vg.jetty.util.Promise;
import com.vg.jetty.util.component.ContainerLifeCycle;
import com.vg.jetty.util.component.Dumpable;
import com.vg.jetty.util.log.Log;
import com.vg.jetty.util.log.Logger;
import com.vg.jetty.util.thread.Scheduler;
...
public class StandardSession implements ISession, Parser.Listener, Dumpable
{
    ...
    public int getLocalStreamCount() {
        return localStreamCount.get();
    }
