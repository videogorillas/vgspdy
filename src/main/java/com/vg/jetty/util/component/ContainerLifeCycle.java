...
package com.vg.jetty.util.component;
...
public class ContainerLifeCycle extends AbstractLifeCycle implements Container, Destroyable, Dumpable
{
    ...
    private final List<Container.Listener> _listeners = new CopyOnWriteArrayList<com.vg.jetty.util.component.Container.Listener>();
