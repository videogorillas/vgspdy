...
import com.vg.jetty.util.B64Code;
import com.vg.jetty.util.IO;
import com.vg.jetty.util.Loader;
import com.vg.jetty.util.StringUtil;
import com.vg.jetty.util.URIUtil;
...
//        return new PathResource(file.toPath());
     ...
     * @see com.vg.jetty.util.resource.ResourceFactory#getResource(java.lang.String)
     */
    @Override
