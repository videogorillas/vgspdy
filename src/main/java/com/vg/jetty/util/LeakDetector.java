 ...
 * {@link #leaked(com.vg.jetty.util.LeakDetector.LeakInfo)} when it detects that a resource
...
public class LeakDetector<T> extends AbstractLifeCycle implements Runnable
{
    ...
    private final ConcurrentMap<String, LeakInfo> resources = new ConcurrentHashMap<String, LeakDetector<T>.LeakInfo>();
