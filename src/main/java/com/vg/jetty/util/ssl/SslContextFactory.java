...
import com.vg.jetty.util.IO;
import com.vg.jetty.util.component.AbstractLifeCycle;
import com.vg.jetty.util.log.Log;
import com.vg.jetty.util.log.Logger;
import com.vg.jetty.util.resource.Resource;
import com.vg.jetty.util.security.CertificateUtils;
import com.vg.jetty.util.security.CertificateValidator;
import com.vg.jetty.util.security.Password;
...
public class SslContextFactory extends AbstractLifeCycle
{
     ...
     * @see com.vg.jetty.util.component.AbstractLifeCycle#doStart()
     */
    @Override
    ...
    {
        Set<String> selected_ciphers = new CopyOnWriteArraySet<String>();
